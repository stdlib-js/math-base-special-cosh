...
```javascript
import cosh from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-cosh@v0.2.4-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-cosh/actions/workflows/test.yml/badge.svg?branch=v0.2.4
[test-url]: https://github.com/stdlib-js/math-base-special-cosh/actions/workflows/test.yml?query=branch:v0.2.4
